...
<div id="edit-slug-box" @if (empty($value) && !$errors->has($name)) class="hidden" @endif>
    @if (in_array(Route::currentRouteName(), ['pages.create', 'pages.edit']) && theme_option('homepage_id', setting('show_on_front')) && theme_option('homepage_id', setting('show_on_front')) == Route::current()->parameter('page'))
