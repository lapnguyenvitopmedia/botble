<div class="gallery-images-wrapper">
    ...
    <div class="images-wrapper">
        ...
        <ul class="list-unstyled list-gallery-media-images clearfix @if (!is_array($images) || empty($images)) hidden @endif">
                    ...
                    @if (!empty($image))
                        <li class="gallery-image-item-handler">
                            ...
                            <div class="custom-image-box image-box">
                                ...
                                <img src="{{ RvMedia::getImageUrl($image, 'thumb') }}" alt="{{ trans('core/base::base.preview_image') }}"
                                     class="preview_image">
                                <div class="image-box-actions">
                                    <a class="btn-images" data-result="{{ $name }}"
